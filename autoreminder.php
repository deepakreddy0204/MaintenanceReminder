...
<header>
    <nav>
        <ul>
            ...
            <li><a href="homeRemainder.php">Home Reminders</a>&nbsp;&nbsp;</li>
...
$result = mysqli_query($con, "SELECT * from maintenance_remainder where username='$username' and type='auto'");
...
<div class="add-reminder-link">
    <a href="addautoReminder.php">Add a New Auto Reminder</a>
</div>
