...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `maintenance_remainder` (type, task, username, due_date)
              VALUES ('finance','$task', '$username', '$dueDate')";
...
<form class="form" action="" method="post" name="addFinacneReminder">
    <h3 class="login-title">Add a New Finance Reminder</h3>
    <input type="text" class="login-input" name="task" placeholder="Task (EMI, Credit Card)" required />
