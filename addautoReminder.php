...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `maintenance_remainder` (task, type, username, due_date)
              VALUES ('$task', 'auto', '$username', '$dueDate')";
...
<form class="form" action="" method="post" name="addCarReminder">
    <h3 class="login-title">Add a New Auto Maintenance Reminder</h3>
    <input type="text" class="login-input" name="task" placeholder="Maintenance Task (e.g., Oil Change)" required />
